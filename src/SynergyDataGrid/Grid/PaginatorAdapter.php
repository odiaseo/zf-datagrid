<?php
    ...
    class PaginatorAdapter implements AdapterInterface
    {
         ...
         * @return void
         */
        public function __construct($service, $filter = false, $sort = false, $grid = null, $treeData = null)
        {
         ...
         * @param array $options
         */
        public function buildTreeFilterQuery($options = array())
        {
        ...
        public function filter($field, $value, $expression, $options = array())
        {
            if (isset($options['multiple'])) {
                ...
                $this->_qb->andWhere($this->getService()->getAlias() . '.' . $field . ' ' . str_replace('?', ':' . $field, $this->_operator[$expression]));
