...
class JqGrid extends Base
{
    ...
    protected $_jsCode;
    protected $_url;
    protected $_exludedColumns = array(
        'siteId',
        'children',
        'root'
    );
     ...
     * @return void
     */
    public function __construct(BaseService $service, array $options = array())
    {
        ...
        foreach ($mapping->fieldMappings as $map) {
            ...
            if (in_array($map['fieldName'], $this->_exludedColumns)) {
                continue;
            }
        ...
        $this->addColumns($columnData)
            ...
            ->setAllowEdit(true)
            ->setAllowDelete(true)
            ->setNavButton(array('icon' => PredefinedIcons::ICON_SUITCASE,
     ...
     */
    protected
    function _setDefaultOptions($id = '')
    {
        $this->setId($id);
        ...
        $this->setHeight('auto');
        $this->setAllowResizeColumns(true);
     ...
     */
    public
    function addColumn($columnTitle = '', $column = array())
    {
     ...
     */
    protected
    function _createGridData(Request $request)
    {
     ...
     */
    public
    function getGridData(Request $request)
    {
     ...
     */
    public
    function attachDetail($options = array())
    {
     ...
     */
    public
    function attachToMaster($masterId = '')
    {
     ...
     */
    public
    function setView(Zend_View_Interface $view = null)
    {
        $this->_view = $view;
        return $this;
    }
    ...
    /**
     * Set Html code for jqGrid
     *
     * @param string $html html code for jqGrid
     *
     * @return \SynergyDataGrid\Grid\JqGrid
     */
    public
    ...
    /**
     * Set JS code for jqGrid
     *
     * @param string $js JS code for jqGrid
     *
     * @return \SynergyDataGrid\Grid\JqGrid
     */
    public
    ...
    /**
     * Get JS code placed in onload section for jqGrid
     *
     * @return string
     */
    public
    ...
    /**
     * Set JS code placed in onload section for jqGrid
     *
     * @param string $onload JS code for jqGrid
     *
     * @return \SynergyDataGrid\Grid\JqGrid
     */
    public
     ...
     */
    public
    function setActionsColumn($actionsColumn)
    {
    ...
    /**
     * Set allowEdit setting and make corresponding changes in JqGrid object
     *
     ...
     */
    public
    function getAllowEditForm()
    {
        return $this->_allowEditForm;
    }

    /**
     * Set allowEditForm setting and make corresponding changes in JqGrid object
     *
     ...
     */
    public
    function setAllowEditForm($allowEditForm)
    {
    ...
    /**
     * Set allowDelete setting and make corresponding changes in JqGrid object
     *
    ...
    /**
     * Set allowAdd setting and make corresponding changes in JqGrid object
     *
     ...
     */
    public
    function getLastSelectVariable()
    {
     ...
     */
    public
    function setLastSelectVariable($lastSelectVariable)
    {
     ...
     */
    public
    function getProcessAfterSubmit()
    {
     ...
     */
    public
    function setProcessAfterSubmit($processAfterSubmit = '')
    {
     ...
     */
    public
    function setInlineNavEnabled($inlineNavEnabled)
    {
     ...
     */
    public
    function setNavGridEnabled($navGridEnabled)
    {
     ...
     */
    public
    function setMultipleSearch($multipleSearch)
    {
     ...
     */
    public
    function getRowActionButton($name = '')
    {
        $return = '';
     ...
     */
    public
    function setRowActionButton($options = array())
    {
     ...
     */
    public
    function setRowActionButtons($rowActionButtons = array())
    {
     ...
     */
    public
    function setNavButton($options = array())
    {
     ...
     */
    public
    function setNavButtons($navButtons = array())
    {
     ...
     */
    public
    function setAllowResizeColumns($allowResizeColumns = true)
    {
     ...
     */
    public
    function setReloadAfterResize($reloadAfterResize)
    {
     ...
     */
    public
    function getReloadAfterChangeColumnsOrdering()
    {
     ...
     */
    public
    function setReloadAfterChangeColumnsOrdering($reloadAfterChangeColumnsOrdering)
    {
     ...
     */
    public
    function setIsDetailGrid($isDetailGrid)
    {
     ...
     */
    public
    function setMasterGridId($masterGridId)
    {
